...
app.get("/", (req, res) => res.send("<h1>Data Base for MERN Blog App by Khalek</h1>"));
...
app.post("/posts", ceckAuth, postCreateValidation, handleValidatonErrors, PostController.create);
